...
currentDir <- this.path::this.dir()

stratumTif <- file.path(currentDir, "initial-stratum.tif")
sclassTif <- file.path(currentDir, "initial-sclass.tif")
ageTif <- file.path(currentDir, "initial-age.tif")
```
