...
if (is.element("demosales", package()$name)) removePackage("demosales")
if (is.element("dgsim", package()$name)) removePackage("dgsim")
if (is.element("epi", package()$name)) removePackage("epi")
if (is.element("helloworld", package()$name)) removePackage("helloworld")
if (is.element("helloworldEnhanced", package()$name)) removePackage("helloworldEnhanced")
if (is.element("landfirevegmodels", package()$name)) removePackage("landfirevegmodels")
if (is.element("stsim", package()$name)) removePackage("stsim")
if (is.element("stsimsf", package()$name)) removePackage("stsimsf")
```
