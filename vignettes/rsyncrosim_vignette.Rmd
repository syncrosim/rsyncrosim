...
library(here)        # package for setting relative paths
```
...
```{r create library, warning = FALSE, results = FALSE}
...
```{r open project, warning = FALSE, results = FALSE}
...
```{r create scenario, warning = FALSE, results = FALSE}
...
myInputDataframe <- data.frame(
  mMean = 0, mSD = 4,
  InterceptRasterFileName = here("vignettes", "input-raster.tif"))
```
...
```{r view results datasheets, warning = FALSE, results = FALSE}
