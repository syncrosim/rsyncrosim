...
Currently our input Scenario Datasheet is empty! We need to add some values to our input Datasheet (`InputDatasheet`) so we can run our model. First, assign the contents of the input Datasheet to a new data frame variable, then check the columns that need input values.
