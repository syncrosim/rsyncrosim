---
title: "Introduction to `ST-Sim` in `rsyncrosim`"
...
`rsyncrosim` is a package designed to facilitate the development of modeling workflows in R for the [SyncroSim](https://syncrosim.com/) software framework.
