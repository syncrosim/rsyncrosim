...
myScenario = scenario(myProject,scenario="breakpoint test copy",sourceScenario = "breakpoint test")
...
myFlatScenario =scenario(myProject,scenario="breakpoint flat") # this is a "paste and merge dependencies" copy of "breakpoint test" scenario
