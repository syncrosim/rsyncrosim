...
#> 14           ecoClassify   2.4.0
#> 15            helloworld   2.1.0
#> 16            helloworld   2.1.1
#> 17    helloworldPipeline   2.1.0
#> 18    helloworldPipeline   2.1.1
#> 19     helloworldSpatial   2.1.0
#> 20        helloworldTime   2.1.0
#> 21        helloworldTime   2.1.1
#> 22 helloworldUncertainty   2.1.0
#> 23 helloworldUncertainty   2.1.1
#> 24     landfirevegmodels   2.0.0
#> 25          lucasbuilder   2.0.2
#> 26          lucasbuilder   2.0.4
#> 27             omniscape   2.2.0
#> 28             omniscape   2.7.0
#> 29            prioritizr   2.2.2
#> 30            prioritizr   3.0.0
...
#> 14                                                                  ecoClassify package for image classification
#> 15                                                       Example demonstrating how to create a SyncroSim package
#> 16                                                       Example demonstrating how to create a SyncroSim package
...
#> 21                                                    Example demonstrating how to use timesteps with an R model
#> 22                                                   Example demonstrating how to use iterations with an R model
#> 23                                                   Example demonstrating how to use iterations with an R model
#> 24                                                                                    LANDFIRE vegetation models
#> 25 Integrates the Carbon Budget Model of the Canadian Forest Sector (CBM-CFS3) into the ST-Sim simulation model.
#> 26 Integrates the Carbon Budget Model of the Canadian Forest Sector (CBM-CFS3) into the ST-Sim simulation model.
#> 27                                                 Omni-directional habitat connectivity based on circuit theory
#> 28                                                 Omni-directional habitat connectivity based on circuit theory
#> 29                                                                              Systematic conservation planning
...
#> 36                             Calculates TNC's unified ecological departure from reference conditions in ST-Sim
...
#> 14        https://apexrms.github.io/ecoClassify/
#> 15         https://apexrms.github.io/helloworld/
#> 16         https://apexrms.github.io/helloworld/
...
#> 23 https://apexrms.github.io/helloworldEnhanced/
#> 24  https://apexrms.github.io/landfirevegmodels/
#> 25       https://apexrms.github.io/lucasbuilder/
#> 26       https://apexrms.github.io/lucasbuilder/
#> 27          https://apexrms.github.io/omniscape/
#> 28          https://apexrms.github.io/omniscape/
#> 29          https://apexrms.github.io/prioritizr
#> 30          https://apexrms.github.io/prioritizr
#> 31                       https://docs.stsim.net/
#> 32                       https://docs.stsim.net/
#> 33                       https://docs.stsim.net/
#> 34                       https://docs.stsim.net/
#> 35                       https://docs.stsim.net/
#> 36                       https://docs.stsim.net/
#> 37              https://apexrms.github.io/wisdm/
#> 38              https://apexrms.github.io/wisdm/
#> 39              https://apexrms.github.io/wisdm/
#> 40              https://apexrms.github.io/wisdm/
#> 41              https://apexrms.github.io/wisdm/
 
# Check the package(s) in your SsimLibrary
packages(myLibrary)
#>    name                                      description version schema status
#> 1  core                           SyncroSim Core Package  3.1.30    3.1     OK
