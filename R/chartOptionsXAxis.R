...
#' Modify the X Axis of a \code{\link{Chart-class}}
#'
...
#' 
#' @export
setGeneric("chartOptionsXAxis", function(
    chart, title = NULL, numberStyle = NULL, decimals = NULL, 
    thousandsSeparator = NULL) standardGeneric("chartOptionsXAxis"))

#' @rdname chartOptionsXAxis
setMethod("chartOptionsXAxis", signature(chart = "Chart"), 
