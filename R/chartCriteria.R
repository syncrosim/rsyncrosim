...
#'
#' @param ssimObject \code{\linkS4class{Project}} or \code{\linkS4class{Chart}} object
#' @param chart character or integer. Either the name or ID of an existing chart.
#' If \code{NULL} and a \code{\linkS4class{Project}} is provided as the first argument,
