...
#' Run scenarios
#'
#' Run one or more SyncroSim \code{\link{Scenario-class}}(s).
#'
#' @param ssimObject \code{\link{SsimLibrary-class}}, \code{\link{Project-class}}, or
#'     \code{\link{Scenario-class}} object, or a list of Scenarios, or character (i.e.
