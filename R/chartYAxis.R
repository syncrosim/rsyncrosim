...
#' myChart <- chartYAxis(myChart, title = "Year")
#' 
#' # Return a dataframe of the current Y axis settings
#' myChart <- chartYAxis(myChart)
#' }
#' 
#' @export
setGeneric("chartYAxis", function(
    chart, title = NULL, numberStyle = NULL, decimals = NULL, 
    thousandsSeparator = NULL, minZero = NULL, sameScale = NULL, 
    fixedIntervals = NULL) standardGeneric("chartYAxis"))

#' @rdname chartYAxis
setMethod("chartYAxis", signature(chart = "Chart"), 
