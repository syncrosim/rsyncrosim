...
test_that("Test simple non-spatial STSim example - assumes that SyncroSim is installed.", {
  ...
  sheetName = "Stratum"; mySheet = datasheet(myProject,name=sheetName,empty=F,optional=T)
  ...
  expect_warning(datasheet(myProject,name=sheetName,empty=F),
  ...
  sheetName = "StateClass"; mySheet = datasheet(myProject,name=sheetName,empty=T)
  ...
  sheetName = "DeterministicTransition"; mySheet = datasheet(myScenario,name=sheetName,optional=T,empty=T)
